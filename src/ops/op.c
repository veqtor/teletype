...
const tele_op_t *tele_ops[E_OP__LENGTH] = {
    ...
    &op_JF_TUNE, &op_JF_QT, &op_KR_PRESET, &op_KR_PATTERN, &op_KR_SCALE,
    &op_KR_PERIOD, &op_KR_POS, &op_KR_LOOP_ST, &op_KR_LOOP_LEN, &op_KR_RESET,
    &op_MP_PRESET1, &op_MP_RESET1, &op_MP_STOP1, &op_MP_SCALE, &op_MP_PERIOD,
    &op_LV_PRESET, &op_LV_RESET, &op_LV_PATTERN, &op_LV_LOOP_ST,
